import BindVertexArray from '../utils/BindVertexArray';
import CreateProgram from '../utils/CreateProgram';
import CreateShader from '../utils/CreateShader';
import CreateBuffer from '../utils/CreateBuffer';
import CreateAttribDesc from '../utils/CreateAttribDesc';
import VertexBuffer from '../utils/VertexBuffer';
import IndexBuffer from '../utils/IndexBuffer';
...
export default class ParticleRenderer implements Renderer {
    ...
    static readonly VERTEX_SIZE = 16;
    static readonly INDEX_SIZE = 2;
    static readonly PARTICLE_VERTEX_COUNT = 4;
    static readonly PARTICLE_INDEX_COUNT = 6;

    // How many 32-bit components does the vertex have.
    static readonly PARTICLE_VERTEX_COMPONENT_COUNT = 4;

    // Can't be bigger since index are 16-bit
    static readonly MAX_PARTICLES = 10000;
    static readonly VERTEX_SHADER_SOURCE = [
    ...
    static readonly FRAGMENT_SHADER_SOURCE = [
    ...
    add(x, y, width, height, umin, vmin, umax, vmax) {
